...
数据来源记录，保证可追溯。**以国家公布的节假日安排为准**，AkShare 负责融合验证、补充缺失区间：

- `manual`：国家/交易所公布的节假日清单（2019-2027），人工编码核对
- `akshare_sina`：AkShare 新浪接口拉取的交易日，与官方清单交叉验证；同时**补充官方清单未覆盖的区间**（如 2019 年以前的年份）

AkShare 不是唯一来源，只作为融合验证与缺失区间的补充手段。
...
- `--fetch` 从 AkShare 拉已公布年份交易日，**交叉验证 + 补充缺失区间**（官方清单未覆盖的年份），合并后**裁剪到 `[1990-12-19, 2035-12-31]`**，仅保留窗口内日期
